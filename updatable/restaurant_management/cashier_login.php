...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM employees WHERE username='$username' AND password='$password' AND role='Cashier'";
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">
          <h3 class="mb-0">Cashier Login</h3>
          <h4 class="justify-content-end" style="float:right"><a href="Manager_login.php" style="text-decoration:none;color:white">Manager</a></h4>
