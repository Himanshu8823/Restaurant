                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Mess Menu Items</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body table-responsive">
                            <table id="menuItemsTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    // Display menu items fetched from the database
                                    while ($row = mysqli_fetch_assoc($menu_items_result)) {
                                        ...
                                        echo "<td>" . ($row['is_available'] ? "Available" : "Not Available") . "</td>";
                                        echo "<td>";
                                        echo "<a href='edit_mess_menu.php?rs_id=$rs_id&id=" . $row['item_id'] . "' class='btn btn-primary btn-xs'><i class='fa fa-pencil' style='font-size:20px'></i></a>";
                                        echo "<a href='delete_mess_item.php?rs_id=$rs_id&id=" . $row['item_id'] . "' class='btn btn-danger btn-xs'><i class='fa fa-trash' style='font-size:20px'></i></a>";
