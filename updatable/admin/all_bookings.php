                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23"
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT bookings.*, tables.table_id, restaurant.title
                                                    FROM bookings
                                                    INNER JOIN tables ON bookings.table_id = tables.table_id
                                                    INNER JOIN restaurant ON tables.rs_id = restaurant.rs_id";
                                            $query = mysqli_query($db, $sql);

                                            if (!mysqli_num_rows($query) > 0) {
                                                echo '<td colspan="10"><center>No Bookings Data!</center></td>';
                                            } else {
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $rows['party_size']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $rows['special_requests']; ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
